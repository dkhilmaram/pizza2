...
const PromotionsPage = () => {
  ...
  const promotions = [
    {
      ...
      code: "BIENVENUE10",
      imageUrl:
        "https://images.unsplash.com/photo-1566843972142-a7fcb70de55a?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cGl6emElMjByZXN0YXVyYW50fGVufDB8fDB8fHww",
    },
    {
      id: 2,
      nameKey: "promo2.name",
  ...
  return (
    <>
              ...
              >
                <div className="card-inner">
                  ...
                  <div className="card-content">
                    ...
                    <p className="expiry">
                      {t("validUntil", { date: formatDate(promo.expirationDate) })}
                    </p>
      ...
      {selectedPromo && <div className="backdrop" onClick={() => setSelectedPromo(null)} />}
